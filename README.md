...
- [NixKits](https://github.com/Kihara777/NixKits) - A Nix flake collection pairing packages, NixOS modules and patches with Chinese-language skills for AI coding assistants — upstream update checks, NixOS CLI guidance, config recovery, multi-language project docs and maintenance logging — installable into opencode / codewhale / codex / openclaw.
